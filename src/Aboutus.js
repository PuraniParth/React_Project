export default function Aboutus(){
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Darshan University,Rajkot</h1>
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-500" style={{color:"white"}}>To create a collaborative environment, open to the free exchange of ideas, knowledge, technology, and resources with other academic institutes & industries.</p>
    </div>
